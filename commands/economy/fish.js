...
$description[1;**You went fishing and found a <a:fish:1013668176560664616> **
**And you sold that <a:fish:1013668176560664616>  and got [$random[1;50]]($getBotInvite)$getVar[symbol]**]
$onlyIf[$getGlobalUserVar[rod]>0;**You dont own a <:rod:1013361967433535528>, care to buy one first?]
...
$color[1;$getVar[embed_color]]
$description[1;**You went fishing and found a <a:fish:1013668176560664616> **
**And you sold that <a:fish:1013668176560664616>  and got [$random[100;500]]($getBotInvite)$getVar[symbol]**]
$onlyIf[$getGlobalUserVar[rod]>0;**You dont own a <:rod:1013361967433535528>, care to buy one first?]
