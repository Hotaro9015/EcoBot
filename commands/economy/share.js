...
code:`
$if[$message[3]==silver]
$sendmessage[{newEmbed:{author:item transfered}{description:**Successfully gave $numberSeparator[$get[amount];,]<:silverore:1013367696739553280> to** \`$username[$findUser[$message[2];no]]\` }{color:RANDOM}{footer:Executed by $usertag}{timestamp}{thumbnail:$authoravatar}};no]
...
$sendmessage[{newEmbed:{author:item transfered}{description:**Successfully gave $numberSeparator[$get[amount];,]<:crystal:1013664737520787497> to** \`$username[$findUser[$message[2];no]]\` }{color:RANDOM}{footer:Executed by $usertag}{timestamp}{thumbnail:$authoravatar}};no]
...
$if[$message[3]==ruby]
$sendmessage[{newEmbed:{author:item transfered}{description:**Successfully gave $numberSeparator[$get[amount];,]<:ruby:1013665222935969792> to** \`$username[$findUser[$message[2];no]]\` }{color:RANDOM}{footer:Executed by $usertag}{timestamp}{thumbnail:$authoravatar}};no]
...
$sendmessage[{newEmbed:{author:item transfered}{description:**Successfully gave $numberSeparator[$get[amount];,]<:uranium:1013665498367524994> to** \`$username[$findUser[$message[2];no]]\` }{color:RANDOM}{footer:Executed by $usertag}{timestamp}{thumbnail:$authoravatar}};no]
...
$sendmessage[{newEmbed:{author:item transfered}{description:**Successfully gave $numberSeparator[$get[amount];,]<:sulphur:1013665816618745936> to** \`$username[$findUser[$message[2];no]]\` }{color:RANDOM}{footer:Executed by $usertag}{timestamp}{thumbnail:$authoravatar}};no]
...
$if[$message[3]==common]
$sendmessage[{newEmbed:{author:item transfered}{description:**Successfully gave $numberSeparator[$get[amount];,]<:common:1013630604157403166> to** \`$username[$findUser[$message[2];no]]\` }{color:RANDOM}{footer:Executed by $usertag}{timestamp}{thumbnail:$authoravatar}};no]
...
$sendmessage[{newEmbed:{author:item transfered}{description:**Successfully gave $numberSeparator[$get[amount];,]<:uncommonly:1013630835859132516> to** \`$username[$findUser[$message[2];no]]\` }{color:RANDOM}{footer:Executed by $usertag}{timestamp}{thumbnail:$authoravatar}};no]
...
$if[$message[3]==rare]
$sendmessage[{newEmbed:{author:item transfered}{description:**Successfully gave $numberSeparator[$get[amount];,]<:rare:1013631031024295956> to** \`$username[$findUser[$message[2];no]]\` }{color:RANDOM}{footer:Executed by $usertag}{timestamp}{thumbnail:$authoravatar}};no]
...
$sendmessage[{newEmbed:{author:item transfered}{description:**Successfully gave $numberSeparator[$get[amount];,]<:legendary:1013639038919512155> to** \`$username[$findUser[$message[2];no]]\` }{color:RANDOM}{footer:Executed by $usertag}{timestamp}{thumbnail:$authoravatar}};no]
